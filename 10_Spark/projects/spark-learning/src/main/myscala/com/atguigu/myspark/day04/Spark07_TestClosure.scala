...
object Spark07_TestClosure {
  def main(args: Array[String]): Unit = {
    ...
    val rdd: RDD[String] = sc.makeRDD(List("hello","world","scala","helloSpark")) //Driver
    val searcher: NewSearcher = new NewSearcher("hello") //Driver
    val newRDD: RDD[String] = searcher.myFilter(rdd)
