...
public class JobInitModel {
    ...
    private int numReduceTask = 1;//Reducer数量, 默认为1
    ...
    public JobInitModel(String[] inPaths, String outPath, Configuration conf, Job job, String jobName
            ...
            , int numReduceTask, Class<? extends Reducer> combiner, Class<? extends Reducer> reducer, Class<?> reduceOutKeyClass
